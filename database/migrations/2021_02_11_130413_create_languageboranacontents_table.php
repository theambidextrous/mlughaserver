...
class CreateLanguageboranacontentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('languageboranacontents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('languageboranacontents');
    }
}
