...
class CreateLanguagemaasaicontentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('languagemaasaicontents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('languagemaasaicontents');
    }
}
