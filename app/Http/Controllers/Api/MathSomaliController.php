...
class MathSomaliController extends Controller
{
    public function content_add(Request $req)
    {
        ...
        $id = Mathsomalicontent::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
            'data' => $this->find_somali_math_content(),
        ], 200);
    }
    public function content_edit(Request $req, $id)
    {
        ...
        Mathsomalicontent::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    protected function find_somali_math_content()
    {
        $s = Mathsomalicontent::all();
        if(is_null($s))
        {
            return [];
        }
        $s = $s->toArray();
        return $this->format_somali_math_content($s);
    }
    protected function format_somali_math_content($data)
    {
        $rtn = [];
    ...
    public function quiz_add(Request $req)
    {
        ...
        $id = Mathsomalitest::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function quiz_edit(Request $req, $id)
    {
        ...
        Mathsomalitest::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
