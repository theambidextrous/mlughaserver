...
class LanguageController extends Controller
{
    ...
    public function group_add(Request $req)
    {
        ...
        $id = Languagegroup::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function group_edit(Request $req, $id)
    {
        ...
        $input['name'] = ucwords(strtolower($input['name']));
        Languagegroup::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function section_add(Request $req)
    {
        ...
        $id = Languagesection::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function section_edit(Request $req, $id)
    {
        ...
        $input = $req->all();
        $input['name'] = strtoupper($input['name']);
        Languagesection::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
