...
class LanguageSomaliController extends Controller
{
    public function content_add(Request $req)
    {
        ...
        $id = Languagesomalicontent::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function content_edit(Request $req, $id)
    {
        ...
        Languagesomalicontent::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    {
        $s = Languagesomalicontent::where('id', '!=', 0)->orderBy('id', 'desc')->get();
        if(is_null($s))
        {
            return [];
        }
