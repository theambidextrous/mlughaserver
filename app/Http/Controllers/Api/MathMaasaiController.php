...
class MathMaasaiController extends Controller
{
    public function content_add(Request $req)
    {
        ...
        $id = Mathmaasaicontent::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
            'data' => $this->find_maasai_math_content(),
        ], 200);
    }
    public function content_edit(Request $req, $id)
    {
        ...
        Mathmaasaicontent::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    {
        // $borana = Mathboranacontent::all();
        // $borana = $borana->toArray();
        // foreach( $borana as $_borana ):
        //     unset($_borana['id']);
        //     Mathmaasaicontent::create($_borana);
        // endforeach;
        return response([
            'status' => 200,
            'message' => "done",
    ...
    protected function find_maasai_math_content()
    {
        $s = Mathmaasaicontent::all();
        if(is_null($s))
        {
            return [];
        }
        $s = $s->toArray();
        return $this->format_maasai_math_content($s);
    }
    protected function format_maasai_math_content($data)
    {
        $rtn = [];
    ...
    public function quiz_add(Request $req)
    {
        ...
        $input['label_inner'] = 'SOMALI ' . trim(strtoupper($input['label']));
        /**image left*/
        ...
        $id = Mathmaasaitest::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
            'data' => $this->find_somali_math_quiz(),
        ], 200);
    }
    public function quiz_edit(Request $req, $id)
    {
        ...
        Mathmaasaitest::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    protected function find_somali_math_quiz()
    {
        $s = Mathmaasaitest::all();
        if(is_null($s))
        {
            return [];
        }
        $s = $s->toArray();
        return $this->format_somali_math_quiz($s);
    }
    protected function format_somali_math_quiz($data)
    {
        $rtn = [];
        foreach( $data as $_data ):
