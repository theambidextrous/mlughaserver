...
class EnvVideoController extends Controller
{
    /** Video */
    public function video_add(Request $req)
    {
        ...
        $id = Environmentvideo::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function video_edit(Request $req, $id)
    {
        ...
        Environmentvideo::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    protected function format_environment_video($data)
    {
        ...
        foreach( $data as $_data ):
            $_data['glabel'] = Environmentgroup::find($_data['group'])->name;
