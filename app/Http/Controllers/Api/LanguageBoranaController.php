...
class LanguageBoranaController extends Controller
{
    public function content_add(Request $req)
    {
        ...
        $id = Languageboranacontent::create($input)->id;
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    public function content_edit(Request $req, $id)
    {
        ...
        Languageboranacontent::find($id)->update($input);
        return response([
            'status' => 200,
            'message' => "done",
            'id' => $id,
    ...
    {
        $s = Languageboranacontent::where('id', '!=', 0)->orderBy('id', 'desc')->get();
        if(is_null($s))
        {
            return [];
        }
